...
public class ParenHighlighter implements CaretListener
{
    ...
    public void clearHighlights()
    {
        ...
        {
            if ( m_start != null ) m_highlighter.removeHighlight( m_start );
            if ( m_end != null ) m_highlighter.removeHighlight( m_end );
            m_start = null;
            m_end = null;
            m_highlighter = null;
        }
        ...
        final int paren ) throws BadLocationException
    {
        ...
        for (; i >= 0; i-- )
        {
            ...
            if ( isOpenParen( c ) && notEscaped( doc, i ) ) parenCount--;
            else if ( isCloseParen( c ) && notEscaped( doc, i ) ) parenCount++;
