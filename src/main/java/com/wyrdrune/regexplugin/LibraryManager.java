...
import com.wyrdrune.regexplugin.event.Notifiable;
...
public class LibraryManager implements ActionListener, PopupMenuListener, Notifiable {
  ...
  private com.wyrdrune.regexplugin.RegexPanel m_panel;
  ...
  public void init(final com.wyrdrune.regexplugin.RegexPanel panel) {
    m_panel = panel;
  }
...
//    System.out.println("Delete " + libraryName);
    ...
    try {
      ...
      com.wyrdrune.regexplugin.Utils.handleException("error.libraryDelete", e);
    }
  }
...
//    System.out.println( "lib" + libraryName + ":" + getCurrentLibraryName() );
  ...
  public void imported() {
    ...
    try {
      ...
      com.wyrdrune.regexplugin.Utils.handleException("error.importingLibrary", e);
    }
    loadModel(m_panel.getLibraryModel());
  }
  ...
  public static void exportFile(final String fileName) {
    ...
    try {
      ...
      com.wyrdrune.regexplugin.Utils.handleException("error.exportingLibrary", e);
    }
  }
