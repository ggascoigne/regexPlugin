...
import com.wyrdrune.regexplugin.ui.MenuEx;
...
public class Swing extends ComponentManager {
  ...
  public Color getDefaultBackgroundColor() {
    return UIManager.getColor("TextArea.color");
  }
  ...
  public StyleTuple getStyleFor(TokenType type) {
    switch (type) {
      ...
      case WORD:
        return new StyleTuple(Color.BLACK, Font.PLAIN);
      case NUMBER:
        return new StyleTuple(Color.RED, Font.PLAIN);
      case PUNCTUATION:
        return new StyleTuple(new Color(102, 14, 122), Font.BOLD);
      case COMMENT:
        return new StyleTuple(Color.gray, Font.ITALIC);
      case CHARACTER:
        return new StyleTuple(Color.MAGENTA, Font.PLAIN);
      case CLASS:
        return new StyleTuple(new Color(0, 0, 128), Font.BOLD);
      case BOUNDARY:
        return new StyleTuple(Color.BLUE, Font.PLAIN);
      case QUANTIFIER:
        return new StyleTuple(Color.BLUE, Font.BOLD);
      default:
      case UNRECOGNIZED:
        return new StyleTuple(Color.RED, Font.PLAIN);
    }
