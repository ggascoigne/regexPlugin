...
Version 0.7.2
 - Add option to copy the regex as is, skipping the conversion to java
 strings.

 - Fixed a stupid mistake in not testing with multiple projects open at once.
 This showed up as an assertion failure when opening a second project.
 Mea culpa.

Version 0.7.1
 - Major revamp of the color handling.  The colors used in the plugin
 now reflect the color scheme chosen in the rest of IntelliJ.  This
 makes the text much more readable if you use any of the dark themes
 available.
